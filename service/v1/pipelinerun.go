...
func (t *PipelineRun) List(ctx context.Context, opts metav1.ListOptions) (resp []tektonv1.PipelineRun, conti string, err error) {
	url := fmt.Sprintf("/apis/tekton.dev/v1/namespaces/%s/pipelineruns", t.namespace)
	if t.namespace == "" {
